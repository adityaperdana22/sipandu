...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Form Create Informasi</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item">Informasi</li>
            <li class="breadcrumb-item active" aria-current="page">Form Create Informasi</li>
        </ol>
    </div>
                    ...
                    <form method="post" action="{{ route('informasi.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="" class="form-control">
                                        ...
                                        <option value="{{ $data->category_id }}">{{ $data->category_nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                          ...
                          email with anyone else.</small> --}}
                                ...
                                <div class="form-group">
                                    <label>Lampiran <small class="text-danger">Tipe : PDF</small></label>
                                    <div class="custom-file">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Deskripsi</label>
                                      <textarea name="informasi_deskripsi" id="editor" cols="30" rows="10"></textarea>
                                </div>
