...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Form Create pendatang</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item">pendatang</li>
            <li class="breadcrumb-item active" aria-current="page">Form Create pendatang</li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('pendatang.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat_asal" class="form-control" placeholder="Masukkan alamat asal">
                                    {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your
                          email with anyone else.</small> --}}
                                </div>
                                <div class="form-group">
                                    <label for="">Tanggal Menetap</label>
                                    <input type="date" name="tanggal_menetap" class="form-control" placeholder="Masukkan NIK">
                                    {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your
                          email with anyone else.</small> --}}
                                </div>
                                <div class="form-group">
      ...
      email with anyone else.</small> --}}
                        ...
                        <a href="{{ route('pendatang.index') }}" class="btn btn-dark">Kembali</a>
                    </form>
                </div>
            </div>
        </div>
